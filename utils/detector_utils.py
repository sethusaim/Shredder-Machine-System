...
from utils import alertcheck, label_map_util
...
def draw_box_on_image(
    ...
    for i in range(num_hands_detect):
        ...
        if scores[i] > score_thresh:
            ...
            cv2.putText(
                image_np,
                "distance from camera: " + str("{0:.2f}".format(dist) + " inches"),
            ...
            a = alertcheck.drawboxtosafeline(
                image_np, p1, p2, Line_Position2, Orientation
            )
        if hand_cnt == 0:
            b = 0
            # print(" no hand")
